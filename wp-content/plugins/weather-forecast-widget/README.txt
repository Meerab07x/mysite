...
Tags: weather forecast, weather widget, openweathermap, shortcode, weather
...
🔒 **Recommendation:**  
To avoid unexpected charges, it is highly recommended to set a **billing cap / usage limit** in your OpenWeatherMap account under [Billing Plans](https://home.openweathermap.org/plans) after adding a payment method.

For pricing details and limits, visit: [Pricing - OpenWeatherMap](https://openweathermap.org/price)
...
= 1.1.7 =
* Compatibility check for WordPress 6.8.2 confirmed
* Migration of API requests from OpenWeatherMap One Call 2.5 to One Call 3.0
* Minor improvements and cleanup
= 1.1.6 =
* Compatibility check for WordPress 6.6.2 confirmed
* Minor improvements and cleanup
* Added notice about OpenWeatherMap One Call 3.0 changes (API key now requires billing)
* Preparation for integration of [Weather API](https://www.weatherapi.com/)
= 1.1.5 =
