 ...
 * Description:       "Weather Forecast Widget" displays current weather and hourly/daily forecasts in a widget using a shortcode.
 * Version:           1.1.7
 ...
 */
define( 'WEATHER_FORECAST_WIDGET_VERSION', '1.1.7' );
